...
function createStateActions(store) {
    return {
        ...
        unsetEntryDataItem: function (name) {
        ...
        getEntryDataAsFormData: function () {
            ...
            if (store.editing) {
                formData.set("entry_uid", store.lastEntry.uid);
                formData.set("edit_token", store.lastEntry.edit_token);
            }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            store.editing = true;
                            if (!!store.lastEntry.form) return [3, 2];
                            this.startLoading();
                            return [4, this.fetchEntry()];
                        case 1:
                            entry = _a.sent();
                            this.stopLoading();
                            Vue.set(store, 'entry', entry.data.form || {});
                            return [3, 3];
                        case 2:
                            Vue.set(store, 'entry', store.lastEntry.form || {});
                            _a.label = 3;
                        case 3:
                            this.setSectionUid(this.getFirstSection().uid);
                            this.persist();
                            this.restore(form);
                            return [2];
                    }
        ...
        restore: function (element) {
            ...
            store.editing = this.canEditEntry() && ((storedState === null || storedState === void 0 ? void 0 : storedState.editing) || store.editing);
            store.sectionUid = !this.canRestart() && !store.editing ? "thankyou" : (storedState === null || storedState === void 0 ? void 0 : storedState.sectionUid) || store.sectionUid;
            this.restoreInputsFromEntry(element);
        },
        restoreInputsFromEntry: function (form) {
            Object.entries(store.entry).forEach(function (pair) {
                var inputs = form.querySelectorAll("[name=\"".concat(pair[0], "\"]"));
        ...
        canEditEntry: function () {
            var _a;
            return (((_a = store.survey.settings.can_edit_entry) === null || _a === void 0 ? void 0 : _a.enabled) || false);
        },
        validateSection: function (sectionFormData) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, fetch("".concat(store.config.apiBase, "/survey/section"), {
        ...
        submitEntry: function () {
            return __awaiter(this, arguments, void 0, function (entryFormData) {
                var response;
                if (entryFormData === void 0) { entryFormData = this.getEntryDataAsFormData(); }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, fetch(store.editing ? "".concat(store.config.apiBase, "/entry/").concat(store.lastEntry.uid) : "".concat(store.config.apiBase, "/entry"), {
                                headers: store.config.nonce ? { "X-WP-Nonce": store.config.nonce } : {},
                                method: "post",
                                body: entryFormData,
                            })];
        ...
        fetchEntry: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, fetch("".concat(store.config.apiBase, "/entry/").concat(store.lastEntry.uid), {
                                headers: store.config.nonce ? { "X-WP-Nonce": store.config.nonce } : {},
                                method: "get",
                            })];
                        case 1:
...
var SectionItem = {
    ...
    computed: {
        ...
        canEditEntry: function () {
            return this.$actions.canEditEntry();
        },
        isEditing: function () {
    ...
    methods: {
        reset: function () {
            var _this = this;
            this.$el.querySelectorAll('input, select, textarea').forEach(function (input) {
                if (input.type && input.type.toLowerCase() === 'checkbox' || input.type.toLowerCase() === 'radio') {
                    input.checked = false;
                }
                else {
                    input.value = '';
                }
                _this.$actions.unsetEntryDataItem(input.name);
            });
        },
        reload: function () {
        ...
        submit: function ($event) {
            ...
            formData.set("language", this.$store.config.language);
            var data = {};
...
var Sections = {
    ...
    methods: {
        ...
        cancelEdit: function () {
            this.$actions.cancelEditing(this.$el);
        },
        edit: function () {
            this.$actions.startEditing(this.$el);
        },
        restart: function () {
            this.$actions.reset(this.$el);
        ...
        validate: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                var next, entry;
                var _c;
                var data = _b.data, formData = _b.formData;
                    ...
                    switch (_d.label) {
                        ...
                        case 3:
                            ...
                            if (entry === null || entry === void 0 ? void 0 : entry.uid) {
                                ...
                                this.survey.canEditEntry = !!entry.canEditEntry;
                                if ((_c = entry === null || entry === void 0 ? void 0 : entry.data) === null || _c === void 0 ? void 0 : _c.scoring) {
...
var EmbedResizingBehaviour = (function () {
    ...
    EmbedResizingBehaviour.prototype.receiveRequest = function (event) {
        if (event.data.totalsurvey && event.data.totalsurvey.uid === this.survey.uid && event.data.totalsurvey.action === 'requestHeight') {
            this.postHeight();
        }
    };
...
var SurveyComponent = {
    ...
    mounted: function () {
        ...
        var embedBehavior = new EmbedResizingBehaviour({ uid: this.survey.uid });
        setInterval(embedBehavior.postHeight.bind(embedBehavior), 100);
    },
    methods: {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            e_1 = _b.sent();
                            this.$actions.stopLoading();
                            this.$actions.setGlobalError(((_a = e_1.response) === null || _a === void 0 ? void 0 : _a.error) || (e_1 === null || e_1 === void 0 ? void 0 : e_1.message) || (e_1 === null || e_1 === void 0 ? void 0 : e_1.statusText) || (e_1 === null || e_1 === void 0 ? void 0 : e_1.responseText));
                            Object.entries(e_1.response.data).forEach(function (pair) { var _a; return _this.$actions.setFieldError(pair[0], (_a = pair[1]) === null || _a === void 0 ? void 0 : _a.join("\n")); });
                            this.$nextTick(function () { return _this.$el.scrollIntoView({ behavior: "smooth" }); });
                            return [2, false];
                        case 4: return [2];
                    }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            e_2 = _b.sent();
                            this.$actions.stopLoading();
                            this.$actions.setGlobalError(((_a = e_2.response) === null || _a === void 0 ? void 0 : _a.error) || (e_2 === null || e_2 === void 0 ? void 0 : e_2.message) || (e_2 === null || e_2 === void 0 ? void 0 : e_2.statusText) || (e_2 === null || e_2 === void 0 ? void 0 : e_2.responseText));
                            Object.entries(e_2.response.data).forEach(function (pair) { var _a; return _this.$actions.setFieldError(pair[0], (_a = pair[1]) === null || _a === void 0 ? void 0 : _a.join("\n")); });
                            this.$nextTick(function () { return _this.$el.scrollIntoView({ behavior: "smooth" }); });
                            return [2, false];
                        case 4: return [2];
                    }
...
Vue.directive("other", {
    bind: function (el) {
        el.querySelectorAll('input[type="text"]').forEach(function (input) { return input.addEventListener("input", function (currentInput) {
            el.querySelector("input.other").value = currentInput.target.value;
        }, false); });
        el.querySelectorAll('input.other').forEach(function (input) { return input.addEventListener("change", function (currentInput) {
            el.querySelector('input[type="text"]').value = currentInput.target.value;
        }, false); });
    },
});
Vue.directive("print", {
...
document.querySelectorAll(".totalsurvey-wrapper").forEach(function (wrapperElement) {
    ...
    var surveyModelElement = host.shadowRoot.querySelector("survey-model");
    var surveyModel = JSON.parse(surveyModelElement.textContent);
    surveyModelElement.remove();
